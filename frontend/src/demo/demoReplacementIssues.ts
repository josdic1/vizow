...
export const demoIssues: DemoIssue[] = [
  ...
  },
  {
    ...
    after: "Every photo lands on its Job the moment it's taken, tagged Before/During/After automatically. Search the Job, not your camera roll.",
  ...
  },
  {
    ...
    label: "I've got six jobs going and no idea which one actually needs me today.",
    before: "Status lives in your head — which job's waiting on a permit, which needs a callback, which one's actually done. Nobody else can see it either.",
    after: "One transit line per Job. Every stop — request, visit, change, close — is right there, and you can tap into any of them.",
